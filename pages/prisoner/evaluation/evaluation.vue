<template>
	<div class="evaluation-container">
		...
		<recognition-dialogs ref="recognitionDialogs" useFor="evaluation" :regConfig="regConfig" :isShow="showRecognitionDialogs" @fingerRecognitionSuccess="fingerRecognitionSuccess" @faceRecognitionSuccess="faceRecognitionSuccess" @close="closeRecognitionDialogs"></recognition-dialogs>
	</div>
</template>
...
export default {
	...
	methods: {
		...
		recognitionHandle () {
			...
			this.$nextTick(() => {
				this.$refs.recognitionDialogs && this.$refs.recognitionDialogs.startRecognition(21);
			});
		},
		// 指纹认证成功回调
