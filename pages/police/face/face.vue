      ...
      <div class="face-content">
        ...
        <div class="face-box">
          <div class="face-menu-list">
            <div
              class="face-menu-item"
              :class="currentPage == 1 ? 'face-menu-active' : ''"
              @click="switchPage(1)"
            >
            ...
            <div
              class="face-menu-item"
              :class="currentPage == 2 ? 'face-menu-active' : ''"
              @click="switchPage(2)"
            >
              ...
              <div class="face-form-box">
                ...
                <div class="face-select">
                  ...
                  <xfl-select
                    :list="policeList"
                    clearable
                    :placeholder="'请选择面对面民警'"
                    @change="selectPolice"
                    @clear="clearSelectPolice"
                  ></xfl-select>
                </div>
                <div class="face-select">
                  <label>登记时间：</label>
                ...
                <div class="face-select">
                  ...
                  <xfl-select
                    :list="faceTypeList"
                    clearable
                    :placeholder="'请选择面对面类型'"
                    @change="selectFaceType"
                    @clear="clearFaceType"
                  ></xfl-select>
                </div>
                    ...
                    <div class="image-list">
                      ...
                      >
                        <image
                          class="image"
                          :src="item.uri"
                          @click.stop="previewImg(item.uri)"
                        ></image>
                        <common-icons
                          iconType="icondelete"
                          size="40"
            ...
            <div class="record-table-box">
              <div class="table-head">
                <div
                  ...
                  v-for="(item, index) in faceColumns"
                  :key="index"
              ...
              <scroll-view scroll-y="true" class="record-table-scroll">
                <div
                  class="table-content"
                  v-for="(item, index) in faceRecordList"
                  :key="index"
                >
            ...
            <div class="face-detail-box">
              ...
              <div class="face-detail">
                ...
                <input
                  type="text"
                  class="input-img"
                  v-model="faceDetailInfo.userName"
                  disabled
                />
              </div>
              <div class="face-detail">
                ...
                <input
                  type="text"
                  class="input-img"
                  v-model="faceDetailInfo.registerTime"
                  disabled
                />
              </div>
              <div class="face-detail">
                ...
                <input
                  type="text"
                  class="input-img"
                  v-model="faceDetailInfo.fieldName"
                  disabled
                />
              </div>
              <div class="face-detail face-remark">
                ...
                <textarea
                  :value="faceDetailInfo.situationRecord"
                  :maxlength="-1"
                  disabled
                ></textarea>
              </div>
              <div class="face-detail face-remark">
                ...
                <div class="upload-image">
                  <div class="image-list">
                    <div
                      class="image-item"
                      v-for="(url, index) in faceDetailInfo.urls"
                      :key="index"
                    >
                      <image
                        class="image"
                        :src="url"
                        @click.stop="previewImg(url)"
                      ></image>
                    </div>
                  </div>
                </div>
      ...
      >
        <div class="preview-modal-box">
          <div class="modal-header">
            ...
            <div
              class="modal-close"
              @touchstart.stop="closeModal('PreviewModal')"
            >
              <image src="/static/images/common/close.png"></image>
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      faceTypeList: [],
      // 登记时间
      regDate: dateFormat("YYYY-MM-DD hh:mm", new Date()),
      // 查询日期
  ...
  methods: {
    ...
    // 选择登记时间
    selectRegDate(e) {
      this.regDate = dateFormat("YYYY-MM-DD hh:mm", new Date(e));
    },
    // 情况记录
    faceRemarkChange(e) {
